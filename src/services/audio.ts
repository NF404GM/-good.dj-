...
class AudioEngineService {
    ...
    public startRecording() {
        ...
        this.mediaRecorder.onstop = async () => {
            ...
            // Save recording as browser download (no server backend)
            try {
                ...
                console.log("[AudioEngine] Recording saved as download.");
            } catch (err) {
                console.error("[AudioEngine] Failed to save recording:", err);
            }
        };
